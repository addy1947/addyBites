            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-purple-800 to-purple-400 relative">
                ...
                <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-purple-800 mb-2">Sign Up</h2>
                        ...
                        <div className="space-y-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 bg-gray-100 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 focus:bg-white transition-all duration-200 ${submitted && nameError ? 'border-red-500 focus:ring-red-400' : 'border-transparent'
                                        }`}
                                />
                            </div>
                            {submitted && nameError && (
