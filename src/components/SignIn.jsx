                                    ...
                                    <div className="space-y-2">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-10 pr-4 py-3 bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-white focus:bg-white transition-all duration-200 text-[#4b3621] ${submitted && nameError ? 'border-red-500 focus:ring-red-400' : 'border-transparent'
                                                    }`}
                                            />
                                        </div>
                                        {submitted && nameError && (
